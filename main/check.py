...
def run_object_detection(run_time_s=15):
    unique_centers = [] 
    tolerance = 60
    # max_containers = 5 
    ...
    return container_positions,detected_aruco_positions


if __name__=='main':
    container,aruco=run_object_detection()
    print("\nFinal Vision Output")
    print("Container 3D Positions (mm):", container)
    print("AruCo Pixel Positions:", aruco)
    # output_data = {
